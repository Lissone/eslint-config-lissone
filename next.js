...
module.exports = [
  ...
  // Next.js flat config (includes React, react-hooks, jsx-a11y, import, @next/next)
  ...nextConfig,

  // TypeScript: parser + recommended rules for all files
  ...tsPlugin.configs['flat/recommended'],

  // TypeScript type-checked rules restricted to .ts/.tsx files
  ...tsPlugin.configs['flat/recommended-type-checked-only'].map(config => ({
    ...config,
    files: ['**/*.ts', '**/*.tsx', '**/*.d.ts'],
  })),
  ...
  // Global language options, plugins and custom rules
  {
    languageOptions: {
      globals: {
        ...globals.browser,
